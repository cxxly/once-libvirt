...
from bnlibvirt import sxp
from bnlibvirt import PrettyPrint
from bnlibvirt.Args import ArgError
from bnlibvirt.BNError import BNError, BNInvalidDomain
#from bnlibvirt.XendLogging import log

import resource
import http

from bnlibvirt.web.SrvBase import SrvBase
...
class SrvConstructor:
    ...
    def __init__(self, klass):
        ...
        should be imported as 'from bnlibvirt.server.klass import klass'.
    ...
    def getobj(self):
        ...
        """
        if not self.obj:
            exec 'from bnlibvirt.server.%s import %s' % (self.klass, self.klass)
