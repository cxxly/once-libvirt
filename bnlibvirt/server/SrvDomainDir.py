...
from bnlibvirt.web import http

from bnlibvirt import sxp
# from bnlibvirt import XendDomain
# from bnlibvirt.XendDomainInfo import XendDomainInfo
from bnlibvirt.Args import FormFn
...
#         self.xd = XendDomain.instance()
    ...
    def op_create(self, _, req):
        ...
        try:
            ...
            traceback.print_exc()
            raise BNError("Error creating domain: " + str(ex))
