...
import types
import xmlrpclib
from bnlibvirt.util.xmlrpclib2 import UnixXMLRPCServer, TCPXMLRPCServer
try:
...
from bnlibvirt import BNLogging
from bnlibvirt.BNClient import XML_RPC_SOCKET
from bnlibvirt.BNConstants import DOM_STATE_RUNNING
from bnlibvirt.BNLogging import log
# from bnlibvirt.XendError import XendInvalidDomain
# from bnlibvirt.XendCPUPool import XendCPUPool
...
def get_log():
    f = open(BNLogging.getLogFilename(), 'r')
    try:
        return f.read()
    finally:
        f.close()
...
#         self.storageapi = use_xenapi and BNStorageAPI.BNStorageAPI(auth) or None
    def run(self):
        authmsg = (self.auth == BNVMAPI.AUTH_NONE and 
...
#                 from bnlibvirt import RunSend
#                 RunSend.main()
#                 
#                 #the follow file was import by shixisheng_cxx
#                 from bnlibvirt import P_DataCollect
#                 P_DataCollect.main()
